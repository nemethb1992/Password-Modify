                 ...
                 <div class="col-12 col-sm-12 col-md-8 col-lg-6 p-4 h-50 col-xl-6 blue MyContainer">
					...
					<div class="form-group">
 						<label for="pwd">Régi jelszó:</label>
  						<input type="password" class="form-control h5" value="3HgB8Wy3HgB8Wy" id="pwd-old">
					</div>
					<div class="form-group">
 						<label for="pwd">Új jelszó:</label>
  						<input type="password" class="form-control h5" value="Hxx8kahxx8ka"  id="pwd-new1">
					</div>
					<div class="form-group">
 						<label for="pwd">Új jelszó ismét:</label>
  						<input type="password" class="form-control h5" value="Hxx8kahxx8ka"  id="pwd-new2">
					</div>
